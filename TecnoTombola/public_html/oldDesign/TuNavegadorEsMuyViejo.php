...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <style>
            h1,p{
                color:#B35D24 !important; 
            }
            h3,label,span{
                color:rgb(53, 97, 117) !important;
            }
            textarea{
                height: 200px;
                width: 200px;   
    ...
    <body class="colors">
        ...
        <div class="borderColor">
            ...
            <div class="fae center">
                <h3 class="center">Agregue los participantes desde un archivo o manualmente</h3>
                <form id="upload" name="upload" class="center" action="upload.php" method="post" enctype="multipart/form-data">
                    <input type="file" name="file" id="file" title="Agregar desde un archivo" class="btn btn-large">                                    
                </form>
                <div id="manualmente">
                    <textarea id="textA" placeholder="agregue los participantes" cols="1" ></textarea><br />
                    <small>Separe los participantes presionando la tecla ENTER</small><br />
                    <input type="button" value="Siguiente paso" class="btn btn-large" onclick="inicia();">
                </div>
            </div>
            <div id="cargando" class="center oculto">
                <h2>CARGANDO...</h2>
            </div><div class="oculto center" id="tombola">
                <div id="tombolaControl">
                    ...
                    <input class="btn btn-large" type="button" id="cargar" value="Regresar" onclick="cargar();">
            ...
            <div id="random2" class="center oculto">
                <div>
                </div>
                <!--<input class="btn-inverse btn-large stop" type="button" value="Detener" onclick="detener();"/>-->
            </div>
            <div id="felicitacion" class="center oculto">
                <h2 id="ganador"></h2>
